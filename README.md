...
<p align="center" style="font-size: 9px;">
Figure 10. Time series forecasting cross-validation prediction results. 0.25, 0.5, and 0.75 represent scenarios for the subset ratios 25\%:75\%, 50\%:50\%, and 75\%:25\%. Here, 75\%:25\% indicates that 75\% of the data points from all previous time points were used as the training set to predict 25\% of the current data points. The red squares represent full design cross-validation, and the bars represent sparse design cross-validation results.
